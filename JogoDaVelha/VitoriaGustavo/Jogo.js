...
export default function Jogo() {
    ...
    const seLandscape = width > height;
    ...
    return (
        <View style={[styles.jogo, { flexDirection: seLandscape ? 'row' : 'column' }]}>
            ...
            <Pressable style={styles.botao} onPress={reiniciar}><Text>Reiniciar</Text></Pressable>
